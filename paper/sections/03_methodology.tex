...
\begin{figure}[t]
    \centering
    \includegraphics[width=\columnwidth]{figures/fig1_surprise_heatmap.png}
...
Rather than conflating informational novelty with memory eviction, CAFE mathematically decouples the Storage Salience Gate from the Active Eviction Gate:
\begin{align}
